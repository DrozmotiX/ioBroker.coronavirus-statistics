...
class Covid19 extends utils.Adapter {
    ...
    async onReady() {
        try {
                ...
                try {
                            ...
                            try {
                                ...
                                if (country === 'Germany') {
                                    await this.writeHospitalDataForId(
                                        country,
                                        await HospitalService.getGermanOverallHospitalData(germanHospitalData$),
                                    );
                    ...
                    for (const continentsStatsKey in continentsStats) {
                        ...
                        for (const val in continentsStats[continentsStatsKey]) {
                            ...
                            if (
                                Object.prototype.hasOwnProperty.call(continentsStats[continentsStatsKey], val) &&
                                val !== 'countryInfo' &&
                                val !== 'inhabitants' &&
            ...
            vaccinationData$ = VaccinationService.refreshVaccinationData().catch(error =>
                this.log.warn(`Vaccination Data Warning: ${error}`),
            ...
            germanHospitalIndexData$ = HospitalIndexService.refreshGermanHospitalIndexData().catch(error =>
            ...
            this.terminate('All data handled, adapter stopped until next scheduled moment');
        } catch (error) {
            ...
            if (userCountryTranslator && userCountryTranslator.val) {
                ...
                try {
                    ...
                    Object.keys(userCountries).forEach(countryId => {
                        if (!Object.prototype.hasOwnProperty.call(countryTranslator, countryId)) {
